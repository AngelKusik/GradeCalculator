...
- 📍 About this repository: GradeCalculator: It's a repository containing all files of my .Net Grade Calculator application.
GradeCalculator is a C# Windows Forms application that enables the user to enter a numeric grade for up to 7 courses and calculates the corresponding letter grade. After at least one valid grade is entered, the program will also calculate the numeric average grade for the semester and the respective average letter grade.
